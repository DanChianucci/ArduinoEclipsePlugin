...
/**
 * An exception with a line number attached that occurs during either compile
 * time or run time.
 */
public class RunnerException extends Exception /* RuntimeException */{
	private static final long serialVersionUID = 5238543737171491551L;
	...
	/**
	 * Override getMessage() in Throwable, so that I can set the message text
	...
	/**
	 * Nix the java.lang crap out of an exception message because it scares the
	 * children.
	 * <P>
	 * This function must be static to be used with super() in each of the
	 * constructors above.
	 */
	/*
	 * static public final String massage(String msg) { if
	 * (msg.indexOf("java.lang.") == 0) { //int dot = msg.lastIndexOf('.'); msg
	 * = msg.substring("java.lang.".length()); } return msg; //return (dot ==
	 * -1) ? msg : msg.substring(dot+1); }
	 */
